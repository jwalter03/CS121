...
import weekTen.activity21.User;

/*public class AbstractCustomer extends abstractClassUser {
    ...
    public AbstractCustomer(String name, String email, String password, int number, String pastReser, int loyaltyPts){
